...
start = time.time()
period = 8
face_cas = cv2.CascadeClassifier('D:\Python\Auto_Attender\haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0);
recognizer = cv2.face.LBPHFaceRecognizer_create();
recognizer.read('D:\\Python\\Auto_Attender\\trainer.yml');
flag = 0;
id = 0;
filename = 'filename';
dict = {
